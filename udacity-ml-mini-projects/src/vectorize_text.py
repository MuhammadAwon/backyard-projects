...
temp_counter = 0
signature_words = ["sara", "shackleton", "chirs", "germani"]
...
pickle.dump(word_data, open('../resources/word_data_unix.pkl', "wb"))
pickle.dump(from_data, open('../resources/email_authors_unix.pkl', "wb"))
